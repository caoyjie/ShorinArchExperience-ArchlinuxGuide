...
- [桌面编辑](我的KDE自定义设置.md#桌面编辑)
  - [桌面鼠标功能](我的KDE自定义设置.md#桌面鼠标功能)
  - [桌面组件](我的KDE自定义设置.md#桌面组件)
  - [桌面面板(任务栏)](我的KDE自定义设置.md#桌面面板任务栏)
- [截图软件设置](我的KDE自定义设置.md#截图软件设置)
- [系统设置](我的KDE自定义设置.md#系统设置)
  - [快捷键](我的KDE自定义设置.md#快捷键)
  - [无障碍辅助](我的KDE自定义设置.md#无障碍辅助)
  - [窗口管理](我的KDE自定义设置.md#窗口管理)
  - [窗口行为](我的KDE自定义设置.md#窗口行为)
  - [桌面特效](我的KDE自定义设置.md#桌面特效)
  - [虚拟桌面](我的KDE自定义设置.md#虚拟桌面)
- [主题美化](我的KDE自定义设置.md#主题美化)
  - [更换桌面壁纸](我的KDE自定义设置.md#更换桌面壁纸)
  - [更换锁屏壁纸](我的KDE自定义设置.md#更换锁屏壁纸)
  - [文字和字体](我的KDE自定义设置.md#文字和字体)
  - [全局主题](我的KDE自定义设置.md#全局主题)
- [用户头像](我的KDE自定义设置.md#用户头像)
---
